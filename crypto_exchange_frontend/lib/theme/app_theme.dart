...
class AppTheme {
  ...
  static final FluentThemeData lightTheme =
      FluentThemeData.light().copyWith(scaffoldBackgroundColor: Colors.white);

  static final FluentThemeData darkTheme = FluentThemeData.dark()
